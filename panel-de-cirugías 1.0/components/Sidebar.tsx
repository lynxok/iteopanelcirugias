        ...
        <div className="h-full flex flex-col p-4 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-200 scroll-smooth">
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              {(user?.role === 'Medico' || user?.role === 'Residente' || user?.role === 'SuperAdmin') && (
                <motion.div variants={linkVariants}>
                  <NavLink
                    to="/medico"
                    className={linkClass}
              ...
              {(user?.role === 'Administrativo' || user?.role === 'SuperAdmin' || user?.role === 'Gerencia') && (
                <motion.div variants={linkVariants}>
                  <NavLink
                    to="/admin-dashboard"
                    className={linkClass}
              ...
              {user?.role !== 'Medico' && user?.role !== 'Residente' && user?.role !== 'Administrativo de Guardias' && (
                <motion.div variants={linkVariants}>
                  <NavLink
                    to="/kanban"
                    className={linkClass}
              ...
              {user?.role !== 'Ortopedia' && user?.role !== 'Administrativo de Guardias' && (
                <>
                  <motion.div variants={linkVariants}>
                    <NavLink
                      to="/monitor"
              ...
              {user?.role !== 'Medico' && user?.role !== 'Internacion' && user?.role !== 'Tecnico' && user?.role !== 'Ortopedia' && user?.role !== 'Oficina ART' && user?.role !== 'Residente' && user?.role !== 'Administrativo de Guardias' && (
                <>
                  <motion.div variants={linkVariants}>
                    <NavLink
                      to="/results"
                  ...
                  {(user?.role === 'SuperAdmin' || user?.role === 'Facturacion' || user?.role === 'Administrativo' || user?.role === 'Gerencia' || user?.role === 'Direccion') && (
                    <motion.div variants={linkVariants}>
                      <NavLink
                        to="/billing"
                        className={linkClass}
              ...
              {user?.role !== 'Internacion' && user?.role !== 'Medico' && user?.role !== 'Tecnico' && user?.role !== 'Ortopedia' && user?.role !== 'Oficina ART' && user?.role !== 'Residente' && user?.role !== 'Administrativo de Guardias' && (
                <motion.div variants={linkVariants}>
                  <NavLink
                    to="/settings"
                    className={linkClass}
