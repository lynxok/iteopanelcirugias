-- Función para registrar eventos de auditoría (FIXED: Variables separadas)
...
BEGIN
    ...
    -- Buscar información del usuario si existe ID
    IF current_user_id IS NOT NULL THEN
        ...
        -- Si no se encuentra usuario (raro pero posible), mantener defaults o ajustar
        IF NOT FOUND THEN
...
EXCEPTION WHEN OTHERS THEN
    -- Restaurar Exception Block para producción, pero logueando mejor
    RAISE WARNING 'Fallo al registrar auditoría: %', SQLERRM;
    RETURN NEW;
END;
