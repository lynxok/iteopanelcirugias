...
*   **v3.10.72 [2026-07-30]**: Lanzada la versión **v3.10.72**. Agregados los filtros condicionales "Solo Ambulatorias / Guardia" y "Solo Internaciones / Quirófano" en el selector de filtros de la planilla de Facturación (`Billing.tsx`).
